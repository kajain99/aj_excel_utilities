AJ Excel Utilities (  Free Excel & CSV Utility Tools) 
...
Select your destination file (the one you want to enrich) and your source file (the one providing extra columns). One click and the lookup is done.
